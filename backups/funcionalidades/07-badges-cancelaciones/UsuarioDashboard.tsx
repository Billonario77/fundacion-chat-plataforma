...
const UsuarioDashboard: React.FC = () => {
  ...
  const handleCancelarTurno = async (turnoId: string, motivo: string) => {
    try {
      ...
      // Al recibir nueva cancelación, resetear el badge
  ...
  useEffect(() => {
    ...
    const handleNuevaCancelacion = (data: any) => {
      // Si la cancelación es de este usuario, resetear badge
