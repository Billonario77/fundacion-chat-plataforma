...
router.put('/mi-foto', auth_1.authenticateToken, turnosController.actualizarMiFoto);
...
router.get('/cancelaciones/admin', auth_1.authenticateToken, turnosController.obtenerCancelacionesAdmin);
router.get('/cancelaciones/metricas', auth_1.authenticateToken, turnosController.obtenerMetricasCancelaciones);
router.get('/historial/admin', auth_1.authenticateToken, turnosController.getHistorialAdmin);
...
router.get('/horarios-ocupados/:guiaId/:fecha', auth_1.authenticateToken, turnosController.getHorariosOcupados);
router.get('/horarios-ocupados/mi-guia/:fecha', auth_1.authenticateToken, turnosController.getHorariosOcupados);
router.get('/:turnoId/tiempo-sesion', auth_1.authenticateToken, turnosController.getTiempoSesion);
router.post('/:turnoId/solicitar-extension', auth_1.authenticateToken, turnosController.solicitarExtension);
