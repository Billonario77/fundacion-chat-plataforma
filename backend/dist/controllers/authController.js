...
INSERT;
INTO;
usuarios(email, password_hash, nombre, telefono, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, rol, activo);
...
export const login = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const userResult = await pool.query(
            `;
SELECT;
id, email, password_hash, nombre, rol, es_admin;
FROM;
usuarios;
WHERE;
email = $1 `,
...
export const perfil = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
        ...
        const result = await pool.query(
            `;
SELECT;
id, email, nombre, telefono, rol, es_admin, activo, created_at;
FROM;
usuarios;
WHERE;
id = $1 `,
