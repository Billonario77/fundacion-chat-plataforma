...
exports.activarEmergencia = void 0;
...
const activarEmergencia = async (req, res) => {
    ...
    `;
        ...
        if (usuariorol === 'usuario') {
            if (turno.guia_id) {
                (0, socketService_1.notificarUsuario)(turno.guia_id, 'emergencia-activada', {
                    turnoId: turnoId,
                    activadoPor: 'usuario',
            ...
            if (turno.usuario_id) {
                (0, socketService_1.notificarUsuario)(turno.usuario_id, 'emergencia-activada', {
                    turnoId: turnoId,
                    activadoPor: 'guia',
        ...
        (0, socketService_1.notificarAAdmins)('emergencia-activada', {
            turnoId: turnoId,
        ...
        await connection_1.pool.query(`INSERT INTO auditoria_logs (usuario_afectado_id, admin_id, accion, detalles)
       VALUES ($1, $2, $3, $4)`, [
            usuarioId,
            null,
            'emergencia_activada',
...
exports.activarEmergencia = activarEmergencia;
//# sourceMappingURL=emergenciaController.js.map